...
Shader "kode80/PixelRender/PixelArtShader_StencilWrite"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (input_t v)
			{
				...
				o.normal = mul( unity_ObjectToWorld, float4( normalize(v.normal), 0.0 ) ).xyz;
				o.wsVertex = mul( unity_ObjectToWorld, v.pos).xyz;
				o.screenUV = o.pos;
